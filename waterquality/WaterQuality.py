...
def main():
    ...
    if args.GetConfig:
        ...
        if (args.input is None) or (args.out is None):
            ...
            import sys 
            sys.path.insert(0, '/Users/tomershmul/Documents/WaterQuality/waterquality')
            ...
            # twilio
            account_sid = "AC24e5881ea204a8d2f30368d2a746e716"
            auth_token = "7b6347c229527758520aa3f34a713342"

            client = Client(account_sid, auth_token)

 

            numbers = ['+19546143934', '+14043842643', '+19546105799']

            for number in numbers:

                message = client.messages.create(

                body= "\n*** COMMUNITY ALERT ***\nThere is an active sign of water contamination in your area of Kolkata, India.\nPlease refer to this link for more info and further steps: XXX",
                from_="+18559663149",
                to = number
